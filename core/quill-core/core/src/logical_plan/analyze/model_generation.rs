            ...
            LogicalPlan::Extension(extension) => {
                    ...
                    extension.node.as_any().downcast_ref::<ModelSourceNode>()
                {
                    ...
                    let table_scan = match &model_plan.original_table_scan {
                        ...
                        None => {
                            match model.source() {
                                quill_core_base::mdl::ModelSource::RefSql => {
                                ...
                                quill_core_base::mdl::ModelSource::TableReference => {
                                    let table_ref_name = model.table_reference()
                                ...
                                quill_core_base::mdl::ModelSource::Invalid(reason) => {
