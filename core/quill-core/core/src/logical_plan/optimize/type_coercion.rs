...
///
/// The purpose of the Quill engine is to generate the SQL to be executed by the other databases. So we can leave most type coercion issues for the database engine.
