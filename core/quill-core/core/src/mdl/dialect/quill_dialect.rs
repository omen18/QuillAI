...
/// QuillDialect is a dialect for Quill engine. Handle the identifier quote style based on the
...
impl Default for QuillDialect {
    fn default() -> Self {
        QuillDialect::new(&DataSource::default())
    }
}
