...
impl Lineage {
    pub fn new(mdl: &QuillMDL) -> Result<Self> {
    ...
    fn collect_source_columns(mdl: &QuillMDL) -> Result<HashMap<Column, HashSet<Column>>> {
...
pub(super) fn validate_cubes(mdl: &QuillMDL) -> Result<()> {
...
mod test {
    ...
    use crate::mdl::AnalyzedQuillMDL;
    use crate::mdl::Dataset;
    use crate::mdl::QuillMDL;
    ...
    fn test_collect_source_columns() -> Result<()> {
        ...
        let lineage = Lineage::new(&quill_mdl)?;
        assert_eq!(lineage.source_columns_map.len(), 13);
        assert_eq!(
            lineage
                .source_columns_map
                .get(&Column::from_qualified_name("quill.public.a.a1_concat_id"))
                .unwrap()
                .len(),
            2
        );
        let a1_concat_b1 = lineage
            .source_columns_map
            .get(&Column::from_qualified_name("quill.public.a.a1_concat_b1"))
            .unwrap();
        assert_eq!(a1_concat_b1.len(), 2);
        assert!(a1_concat_b1.contains(&Column {
            relation: Some(TableReference::full("quill", "public", "a")),
            name: "b.b1".to_string(),
            spans: Spans::new(),
        }));
        ...
        let a1_concat_c1 = lineage
            .source_columns_map
            .get(&Column::from_qualified_name("quill.public.a.a1_concat_c1"))
            .unwrap();
    ...
    fn test_case_sensitive() -> Result<()> {
        ...
        assert!(lineage
            .source_columns_map
            .contains_key(&Column::from_qualified_name(r#"quill.public."A"."A1""#)));

        assert!(lineage
            .source_columns_map
            .contains_key(&Column::from_qualified_name(
                r#"quill.public."A"."A1_concat_native""#
            )));

        let a1_concat_c1 = lineage
            .required_fields_map
            .get(&Column::from_qualified_name("quill.public.b.a_id"))
            .unwrap();
        let expected: HashSet<Column> = HashSet::from([
            Column::from_qualified_name(r#"quill.public."A"."A1""#),
            Column::from_qualified_name(r#"quill.public."A"."Id""#),
            Column::from_qualified_name("quill.public.b.a1"),
        ]);
    ...
    fn test_collect_required_fields() -> Result<()> {
        ...
        let a1_concat_b1 = lineage
            ...
            .unwrap();
        let expected: HashSet<Column> = HashSet::from([
            Column::from_qualified_name("quill.public.a.a1"),
            Column::from_qualified_name("quill.public.b.a1"),
            Column::from_qualified_name("quill.public.b.b1"),
        ]);
        ...
        let expected: HashSet<Column> = HashSet::from([
            ...
            Column::from_qualified_name("quill.public.b.a1"),
            Column::from_qualified_name("quill.public.b.b1"),
            Column::from_qualified_name("quill.public.c.b1"),
            Column::from_qualified_name("quill.public.c.c1"),
        ]);
        ...
        let c1 = lineage
            .required_fields_map
            .get(&Column::from_qualified_name("quill.public.b.c1"))
            .unwrap();
        let expected: HashSet<Column> = HashSet::from([
            Column::from_qualified_name("quill.public.b.b1"),
            Column::from_qualified_name("quill.public.c.b1"),
        ...
        let a_id_concat_c1 = lineage
            ...
            .get(&Column::from_qualified_name(
                "quill.public.b.a_id_concat_c1",
            ))
            .unwrap();
        let expected: HashSet<Column> = HashSet::from([
            Column::from_qualified_name("quill.public.a.id"),
            Column::from_qualified_name("quill.public.a.a1"),
            Column::from_qualified_name("quill.public.b.a1"),
            Column::from_qualified_name("quill.public.b.b1"),
            Column::from_qualified_name("quill.public.c.b1"),
        ...
        let a_b_c1 = lineage
            .required_fields_map
            .get(&Column::from_qualified_name("quill.public.a.b_c1"))
            .unwrap();
        ...
        let expected: HashSet<Column> = HashSet::from([
            ...
            Column::from_qualified_name("quill.public.b.a1"),
            Column::from_qualified_name("quill.public.b.b1"),
            Column::from_qualified_name("quill.public.b.c1"),
            Column::from_qualified_name("quill.public.c.b1"),
            Column::from_qualified_name("quill.public.c.c1"),
        ]);
    ...
    fn test_required_dataset_topo() -> Result<()> {
        let manifest = ManifestBuilder::new()
            ...
            .build();
        let quill_mdl = QuillMDL::new(manifest);
        let lineage = crate::mdl::lineage::Lineage::new(&quill_mdl)?;
        assert_eq!(lineage.required_dataset_topo.len(), 2);
        let customer_name = lineage
            .required_dataset_topo
            .get(&Column::from_qualified_name("quill.public.a.c1"))
            .unwrap();
        ...
        assert_eq!(source, &Dataset::Model(quill_mdl.get_model("a").unwrap()));

        let second = iter.next().unwrap();
        let target = customer_name.node_weight(second).unwrap();
        assert_eq!(target, &Dataset::Model(quill_mdl.get_model("b").unwrap()));
        ...
        assert_eq!(target, &Dataset::Model(quill_mdl.get_model("c").unwrap()));
    ...
    fn test_validate_cube_valid() {
        let manifest = ManifestBuilder::new()
            ...
            .build();
        if let Err(err) = AnalyzedQuillMDL::analyze(
            manifest,
    ...
    fn test_validate_cube_bad_base_object() {
        let manifest = ManifestBuilder::new()
            ...
            .build();
        let result = AnalyzedQuillMDL::analyze(
            manifest,
            Arc::new(HashMap::default()),
            Mode::Unparse,
        );
