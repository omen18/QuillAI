# Quill Core Benchmarks

This crate contains benchmarks for the Quill core library, based on industry-standard open source benchmarks, designed to help measure and improve the performance of Quill core.
...
This benchmark is used to collect complex SQL test cases for Quill performance evaluation.
...
# Run Quill-specific benchmarks
cargo run --release --bin quill -- benchmark --query 1 -i 10
```

### Command Line Options

- `--query <number>`: Run a specific query (TPC-H: 1-22, Quill: 1-2)
...
│   └── quill/            # Quill-specific benchmark queries
