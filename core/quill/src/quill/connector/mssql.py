...
from quill.connector.base import ConnectorABC
from quill.model import MSSqlConnectionInfo
...
def _connect_mssql_pyodbc(
    ...
    if pyodbc is None:  # pragma: no cover
        raise QuillError(ErrorCode.GET_CONNECTION_ERROR, "pyodbc is required for MSSQL")
