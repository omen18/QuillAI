"""``quill docs`` — connection-info generation."""
...
docs_app = typer.Typer(name="docs", help="Generate documentation for Quill Engine")
...
def docs_connection_info(
    ...
    from quill.docs import generate_json_schema, generate_markdown  # noqa: PLC0415
