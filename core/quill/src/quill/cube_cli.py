"""Typer sub-app for ``quill cube`` commands."""
...
def _load_mdl_json(mdl: str | None) -> str:
    ...
    from quill.cli import _require_mdl  # noqa: PLC0415
...
def query(
    ...
    SQL by quill-core, then executed through QuillEngine just like a regular
    ``quill query``.
    """
    if from_json:
    ...
    from quill.cli import _build_engine, _print_result  # noqa: PLC0415
