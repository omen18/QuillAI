"""Generate documentation for Quill connection info models."""
...
from quill.model import BaseConnectionInfo
from quill.model.field_registry import DATASOURCE_MODELS  # noqa: F401
...
def generate_markdown(datasource: str | None = None) -> str:
    ...
    lines: list[str] = []
    lines.append("# Quill Engine Connection Info Reference")
    lines.append("")
