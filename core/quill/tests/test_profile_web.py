"""Tests for quill.profile_web — browser-based profile creation server."""
...
import quill.profile as profile_mod  # noqa: E402
from quill.profile_web import create_app  # noqa: E402
