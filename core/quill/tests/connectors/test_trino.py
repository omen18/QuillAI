...
shared ``QuillQueryTestSuite`` can run against it.
...
class TestTrino(QuillQueryTestSuite):
    ...
    def engine(self) -> QuillEngine:  # type: ignore[override]
    ...
    def test_scalar_types(self, engine: QuillEngine) -> None:
        result = engine.query(
            "SELECT "
    ...
    def test_temporal_types(self, engine: QuillEngine) -> None:
        result = engine.query(
            "SELECT "
    ...
    def test_array_type(self, engine: QuillEngine) -> None:
    ...
    def test_map_type(self, engine: QuillEngine) -> None:
    ...
    def test_row_type(self, engine: QuillEngine) -> None:
        result = engine.query(
    ...
    def test_anonymous_row_type(self, engine: QuillEngine) -> None:
