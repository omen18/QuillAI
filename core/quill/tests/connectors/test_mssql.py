...
from tests.suite.query import QuillQueryTestSuite  # noqa: E402
from quill import QuillEngine  # noqa: E402
from quill.connector.mssql import MSSqlConnector  # noqa: E402
from quill.model import MSSqlConnectionInfo  # noqa: E402
from quill.model.data_source import DataSource  # noqa: E402
from quill.model.error import QuillError  # noqa: E402
...
class TestMSSqlEngine(QuillQueryTestSuite):
    ...
    def engine(self, conn_info) -> QuillEngine:  # type: ignore[override]
        manifest_str = base64.b64encode(orjson.dumps(self.manifest)).decode()
        with QuillEngine(manifest_str, DataSource.mssql, conn_info, fallback=False) as e:
            yield e
...
def test_url_connection(mssql_container: SqlServerContainer) -> None:
    ...
    from quill.connector.mssql import _build_mssql_connection  # noqa: PLC0415
