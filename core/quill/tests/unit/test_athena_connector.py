...
from quill.connector.athena import (  # noqa: E402
    AthenaConnector,
    _build_athena_arrow_table,
    _parse_athena_type,
)
from quill.model import AthenaConnectionInfo  # noqa: E402
from quill.model.error import ErrorCode, ErrorPhase, QuillError  # noqa: E402
...
def test_connector_uses_oidc_when_web_identity_token_provided(monkeypatch):
    ...
    AthenaConnector(
        _info(
            ...
            role_arn=SecretStr("arn:aws:iam::123:role/quill"),
    ...
    sts_client.assume_role_with_web_identity.assert_called_once_with(
        RoleArn="arn:aws:iam::123:role/quill",
