...
QUILL_MEMORY_BACKEND=grep so they exercise the no-extra path even when the
...
from quill.memory.index_backend import GrepIndex, get_index, resolve_backend
...
def test_resolve_backend_env_override():
    from quill.memory.index_backend import _extra_available  # noqa: PLC0415
