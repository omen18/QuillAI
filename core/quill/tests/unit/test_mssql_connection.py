...
from quill.connector.mssql import (
    MSSqlConnector,
...
def test_mssql_url_decodes_user_database_and_password() -> None:
    ...
    url = (
        ...
        "my%20db?TrustServerCertificate=yes&app%20name=quill"
    )

    with patch("quill.connector.mssql.pyodbc", fake):
