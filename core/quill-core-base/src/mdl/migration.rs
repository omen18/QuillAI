...
mod tests {
    ...
    fn test_migrate_v1_to_v2() {
        let v1_json = r#"{"catalog":"quill","schema":"public","models":[]}"#;
    ...
    fn test_migrate_v2_to_v3() {
        let v2_json = r#"{"layoutVersion":2,"catalog":"quill","schema":"public","models":[]}"#;
    ...
    fn test_migrate_v3_to_v4() {
        let v3_json = r#"{"layoutVersion":3,"catalog":"quill","schema":"public","models":[]}"#;
    ...
    fn test_migrate_v1_to_v3_preserves_composite_pk() {
        let v1_json = r#"{"catalog":"quill","schema":"public","models":[{"name":"partsupp","columns":[],"primaryKey":["ps_partkey","ps_suppkey"]}]}"#;
