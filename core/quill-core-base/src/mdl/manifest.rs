...
impl Display for DataSource {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            DataSource::Quill => write!(f, "QUILL"),
...
mod bool_from_int {
        ...
        D: Deserializer<'de>,
    {
        ...
        match value {
            ...
            // Backward compatibility with Quill manifests
            // In the legacy manifest format generated by Quill, boolean values are represented as integers (0 or 1)
