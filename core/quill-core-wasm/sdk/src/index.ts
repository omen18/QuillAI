import init, { QuillEngine as WasmEngine } from "./quill_core_wasm.js";

export interface QuillProfile {
...
/**
 * Optional configuration for {@link QuillEngine.registerCsv}. All fields are
...
export interface QuillEngineOptions {
  /**
   ...
   *
   * Defaults to sibling quill_core_wasm_bg.wasm resolved via import.meta.url.
   */
...
export class QuillEngine {
   ...
   *
   * Translates the CubeQuery to SQL via quill-core, then executes the SQL
