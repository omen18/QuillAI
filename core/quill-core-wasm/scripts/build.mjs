#!/usr/bin/env node
/**
 * Build script for quill-core-wasm npm package.
 *
...
if (!existsSync(resolve(pkg, "quill_core_wasm_bg.wasm"))) {
  console.error(
...
const pkgFiles = [
  "quill_core_wasm.js",
  "quill_core_wasm.d.ts",
  "quill_core_wasm_bg.wasm",
  "quill_core_wasm_bg.wasm.d.ts",
];
...
// 3. Report
const wasmPath = resolve(dist, "quill_core_wasm_bg.wasm");
