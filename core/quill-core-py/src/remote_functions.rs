...
use std::fmt::Display;
use std::str::FromStr;
use quill_core::mdl::function::FunctionType;
...
impl From<quill_core::mdl::function::RemoteFunction> for PyRemoteFunction {
    fn from(remote_function: quill_core::mdl::function::RemoteFunction) -> Self {
...
impl From<PyRemoteFunction> for quill_core::mdl::function::RemoteFunction {
    fn from(
        remote_function: PyRemoteFunction,
    ) -> quill_core::mdl::function::RemoteFunction {
