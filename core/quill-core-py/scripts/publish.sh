#!/usr/bin/env bash
#
# Build and publish quill-core-py to PyPI or TestPyPI.
#
# Usage:
...
echo "==> Building quill-core-py v${VERSION}"
...
if [[ "$REPOSITORY" == "testpypi" ]]; then
    ...
    echo "    pip install --index-url https://test.pypi.org/simple/ quill-core-py"
else
...
echo ""
echo "==> Done! Published quill-core-py v${VERSION} to ${REPOSITORY}"
