"""Build a Quill-aware system prompt for Pydantic AI agents.
...
def build_instructions(toolkit: QuillToolkit, *, toolset: object | None = None) -> str:
    ...
    ``include_memory_write=False`` drops ``quill_store_query``, the
