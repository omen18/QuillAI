"""LangGraph integration: QuillToolkit tools work inside a compiled graph.
...
def test_toolnode_invokes_quill_query_via_simulated_llm_tool_call(duckdb_project):
...
def test_toolnode_invokes_quill_list_models(duckdb_project):
