...
from quill_langchain._envelope import (
    cap_size,
    format_error,
    json_safe,
    make_error,
...
def test_format_error_extracts_quill_error_fields():
    """format_error pulls code, phase, message, metadata from QuillError."""
    exc = QuillError(
...
def test_format_error_handles_non_quill_exception():
